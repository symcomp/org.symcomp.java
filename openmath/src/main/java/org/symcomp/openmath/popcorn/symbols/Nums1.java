...
public class Nums1 extends SymbolRenderer {
    ...
    ***** nums1.rational
    ...
    public void rational(OpenMathBase[] params, int prec) throws IOException {
        renderBinary(params, "//", prec_rational(), prec);
    }

    /*
    ***** nums1 constants
     */
    public void e() throws IOException { out.write("e"); }
    public void pi() throws IOException { out.write("pi"); }
    public void i() throws IOException { out.write("i"); }
    public void infinity() throws IOException { out.write("infinity"); }
